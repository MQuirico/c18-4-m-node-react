...
export class CreateLegalRecordsDTO {
    constructor(
    ...
    static create(object: { [key: string]: any }): [string?, CreateLegalRecordsDTO?] {
        const {
            fileNum,
            category,
            responsible,
        ...
        return [undefined, new CreateLegalRecordsDTO(fileNum, category, responsible, client, description, priority, notes, attachedDocuments, status, deadline)];
    };
};
